...
export default function View({
    ...
    const [coverImageSrc, setCoverImageSrc] = useState(user.cover || "/img/cover-space.jpg");
                    ...
                    <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-20 mt-4 md:mt-0 py-2">
                        ...
                        <div className="text-center md:text-left mt-4 md:mt-0">
                            ...
                            <p className='text-secondary-600 font-semibold'>
                                Tienes <span className='text-text-950'>{followerCount}</span> <small>followers...</small>
                            </p>
                        </div>
                        ...
                        <div className="mt-4 mb-4 md:mt-0 md:mb-0">
                            {!isMyProfile && (
                                isCurrentUserFollower ? (
                                    ...
                                    <PrimaryButton onClick={followUser} className="flex bg-primary-400 hover:bg-primary-500" >
                                        Follow
                                    </PrimaryButton>
                                )
                            )}
