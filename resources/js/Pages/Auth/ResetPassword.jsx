    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-4">
                    <InputLabel htmlFor="password_confirmation" value="Confirm Password" className='text-text-600' />
                ...
                <div className="flex items-center justify-end mt-4">
                    <PrimaryButton className="ms-4 bg-primary-400 bg-primary-500" disabled={processing}>
                        Reset Password
                    </PrimaryButton>
                </div>
            </form>
